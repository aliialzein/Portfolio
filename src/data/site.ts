...
export const site = {
  ...
  resumeUrl: '/Ali_Alzein_Resume.pdf',
...
export const projects: Project[] = [
  {
    title: 'DenTool',
    description:
      'Full-stack dental e-commerce platform built for the Lebanese market, providing product discovery, category management, and a streamlined WhatsApp-based purchasing workflow.',
    tech: [
      'Next.js',
      'NestJS',
      'TypeScript',
...

  {
    title: 'Food Spot',
    description:
      'Production-style restaurant management and food ordering platform developed during my software engineering internship, supporting restaurant, category, reservation, and ordering workflows.',
    tech: [
      'Next.js',
      'TypeScript',
      'React',
...

  {
    ...
    description:
      'Full-stack room management system developed during internship, focusing on authentication, room allocation, and structured backend design with REST APIs.',
...

  {
    ...
    description:
      'AI-powered inventory management platform that automates product registration using image recognition and price prediction, eliminating manual product entry workflows.',
    tech: [
      'FastAPI',
      'React',
      'MongoDB',
    ...
    featured: true,
    impact:
      'Designed and integrated image classification and price prediction pipelines into a full-stack inventory system with real-time updates and AI-assisted product management.',
  },

  {
    title: 'PsyConnect',
    description:
      'Session management platform for psychotherapists that centralizes scheduling, online consultations, payments, and AI-assisted workflows.',
    tech: [
      'ASP.NET Core MVC',
      'Stripe',
      'OpenAI API',
    ...
    featured: true,
    impact:
      'Integrated external services and AI capabilities into a unified healthcare workflow, reducing administrative effort and simplifying patient interaction.',
  },

  {
    title: 'Plant Disease Detection',
    description:
      'Deep learning application that detects plant diseases from uploaded leaf images and visualizes prediction reasoning using Grad-CAM explainability.',
    tech: [
      'Python',
      'TensorFlow',
      'MobileNetV2',
    ...
    impact:
      'Fine-tuned MobileNetV2 and integrated explainable AI visualization to improve prediction transparency and usability.',
  },

  {
    title: 'Teleco',
    description:
      'End-to-end web, Android, and IOS application design focused on telecom service workflows, account management, and user-centered interaction design.',
    tech: [
      'Figma',
      'UI/UX',
      'Design System',
    ...
    impact:
      'Designed a structured mobile experience emphasizing usability, visual consistency, and scalable component-based design.',
  },
];
...
export const experiences: Experience[] = [
  {
    ...
    location: 'Remote',
    summary:
      'Contributed to Food Spot, a production-style restaurant management and food ordering platform, while collaborating within an Agile software engineering team.',
    achievements: [
      'Developed RESTful backend APIs using Next.js, TypeScript, Prisma, and PostgreSQL following layered architecture principles.',
      'Implemented modules for restaurants, categories, reservations, and orders with validation, error handling, and repository-service architecture.',
      'Built automated unit tests using Vitest and contributed through Git workflows, sprint planning, and code reviews.',
    ],
  },

  {
    ...
    achievements: [
      'Designed relational database schemas and ER diagrams ensuring data integrity and scalable architecture.',
      'Implemented ASP.NET Core backend APIs for room management and authentication systems.',
      'Integrated backend services with a React.js frontend through REST APIs.',
    ],
  },
];
